...
const recipes = [
  ...
  },
  {
    slug: "onigiri",
    title: "Onigiri",
    description: "Japanese rice balls shaped by hand and wrapped with a strip of nori.",
    imageEmoji: "🍙",
    cookTimeMinutes: 25,
    servings: 4,
    ingredients: [
      { text: "3 cups cooked sushi rice", ingredient: "sushi rice", quantity: 3 },
      { text: "1 can tuna, drained", ingredient: "tuna", quantity: 1 },
      { text: "2 tbsp mayonnaise", ingredient: "mayonnaise", quantity: 2 },
    ...
    steps: [
      ...
      "Wet your hands with salted water and scoop a portion of rice into your palm.",
      "Press a small hollow in the center, add a spoonful of tuna filling, and mold the rice into a triangle around it.",
