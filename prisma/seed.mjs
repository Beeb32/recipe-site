...
const recipes = [
  ...
  },
  {
    ...
    description: "Fettuccine tossed with butter, finely grated Parmigiano-Reggiano, and starchy pasta water emulsified off the heat - the original Roman recipe has no cream and no garlic; those are American additions that mask what makes the emulsion work.",
    imageEmoji: "🍝",
    cookTimeMinutes: 20,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "Chicken seasoned with cumin, chili powder, and garlic, melted with Oaxaca (or Monterey Jack) cheese in a lightly oiled tortilla - Oaxaca cheese's stretchy melt and the seasoned chicken are what separate real quesadillas from a plain cheddar-and-chicken pocket.",
    imageEmoji: "🧀",
    cookTimeMinutes: 25,
    servings: 4,
    ingredients: [
  ...
  },
  {
    slug: "buffalo-wings",
    title: "Buffalo Wings",
    description: "Wings tossed in the original Anchor Bar-style sauce of hot sauce, butter, and a splash of vinegar - the vinegar is what the original 1964 recipe calls out as crucial for cutting the richness of the butter, and deep-frying is the traditional method, though baking is a common lighter alternative.",
    imageEmoji: "🍗",
    cookTimeMinutes: 50,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "Salted and drained eggplant, fried until golden, layered with tomato sauce, torn basil, and mozzarella - salting draws out the bitterness and excess moisture that would otherwise make the dish watery and dense.",
    imageEmoji: "🍆",
    cookTimeMinutes: 105,
    servings: 6,
    ingredients: [
