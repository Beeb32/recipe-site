...
const recipes = [
  ...
  },
  {
    slug: "greek-salad",
    title: "Greek Salad",
    description: "Tomato, cucumber, green pepper, red onion, and olives dressed simply with olive oil and salt - no vinegar - topped with a whole slab of feta rather than crumbled, the way it's actually served in Greece.",
    imageEmoji: "🥙",
    cookTimeMinutes: 15,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "Beef velveted in a cornstarch-soy-baking soda marinade before searing, stir-fried with ginger and garlic in a Shaoxing wine-soy sauce - velveting is the technique that gives real Chinese beef and broccoli its silky texture, not just a light cornstarch dust.",
    imageEmoji: "🥦",
    cookTimeMinutes: 40,
    servings: 4,
    ingredients: [
