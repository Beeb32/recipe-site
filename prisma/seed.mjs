...
const recipes = [
  ...
  },
  {
    slug: "caprese-salad",
    title: "Caprese Salad",
    description: "Fresh mozzarella, ripe tomatoes, and basil, finished simply with good olive oil and sea salt - the traditional Capri version skips the balsamic entirely, though a drizzle is a common modern addition.",
    imageEmoji: "🍅",
    cookTimeMinutes: 10,
    servings: 4,
    ingredients: [
  ...
  },
  {
    slug: "aloo-gobi",
    title: "Aloo Gobi",
    description: "Potatoes and cauliflower pan-fried until spotted brown, then simmered in a ginger-garlic-tomato masala with a full spice blend - the base masala and browning the vegetables first are what separate real aloo gobi from plain spiced vegetables.",
    imageEmoji: "🥔",
    cookTimeMinutes: 45,
    servings: 4,
    ingredients: [
  ...
  },
  {
    slug: "saag-aloo",
    title: "Saag Aloo",
    description: "Par-boiled potatoes and blanched spinach simmered into a ginger-garlic base seasoned with a full spice blend - the blanch-and-shock step is what keeps the spinach vivid green instead of dull.",
    imageEmoji: "🥔",
    cookTimeMinutes: 40,
    servings: 4,
    ingredients: [
  ...
  },
  {
    slug: "rajma",
    title: "Rajma",
    description: "Red kidney beans simmered in a ginger-garlic tomato masala built on a full spice blend - classic North Indian comfort food, traditionally served over rice as rajma chawal.",
    imageEmoji: "🫘",
    cookTimeMinutes: 45,
    servings: 4,
    ingredients: [
  ...
  },
  {
    slug: "paneer-tikka",
    title: "Paneer Tikka",
    description: "Paneer marinated in thick hung curd with ginger-garlic, roasted gram flour, and mustard oil, grilled until charred - the hung curd and besan are what give the marinade its cling and the paneer its light crispness.",
    imageEmoji: "🍢",
    cookTimeMinutes: 150,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "Ground chicken stir-fried with garlic, shallot, and chilies in a fish sauce-oyster sauce-soy blend, finished with holy basil off the heat and served over rice with a crispy fried egg - the sauce blend and basil timing are what make it taste like real pad krapow, not just chicken with basil.",
    imageEmoji: "🌶️",
    cookTimeMinutes: 25,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "Day-old jasmine rice stir-fried over high heat with garlic, egg, and chicken, seasoned with fish sauce poured around the hot edge of the wok so it flash-evaporates into the rice - finished with white pepper, lime, and cucumber the way it's served on the street in Thailand.",
    imageEmoji: "🍚",
    cookTimeMinutes: 20,
    servings: 4,
    ingredients: [
  ...
  },
  {
    slug: "papaya-salad",
    title: "Papaya Salad",
    description: "Green papaya pounded in a mortar and pestle with garlic, chilies, and long beans, then dressed with fish sauce, lime, and palm sugar - the pounding technique, not just tossing, is what defines real som tam.",
    imageEmoji: "🥗",
    cookTimeMinutes: 20,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "Rice noodles tossed in a peanut sauce built on garlic, ginger, and coconut milk - the aromatics and coconut milk are what separate real Thai peanut sauce from peanut butter thinned with soy sauce.",
    imageEmoji: "🍜",
    cookTimeMinutes: 25,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "Pork belly and hard-boiled eggs braised in a dark sugar caramel with fish sauce, shallots, and coconut water until deeply savory-sweet and glossy - the eggs are as essential as the pork in real thit kho, and the caramel is built from scratch, not just melted sugar.",
    imageEmoji: "🍖",
    cookTimeMinutes: 120,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "Pan-seared salmon glazed with a real teriyaki sauce of soy sauce, sake, mirin, and sugar reduced to a thin, glossy glaze - not the cornstarch-thickened, overly sweet version common outside Japan.",
    imageEmoji: "🐟",
    cookTimeMinutes: 20,
    servings: 4,
    ingredients: [
  ...
  },
  {
    slug: "yakisoba",
    title: "Yakisoba",
    description: "Stir-fried wheat noodles cooked over high heat with pork and vegetables, sauced at the very end so the sugar doesn't scorch, and finished with aonori and pickled red ginger - the garnishes are what make it taste like real yakisoba, not just noodles in sauce.",
    imageEmoji: "🍜",
    cookTimeMinutes: 25,
    servings: 4,
    ingredients: [
  ...
  },
  {
    slug: "okonomiyaki",
    title: "Okonomiyaki",
    description: "A savory Japanese cabbage pancake bound with grated mountain yam for a light, fluffy texture, rested before cooking, and topped with okonomiyaki sauce, mayonnaise, and aonori - bonito flakes are the traditional finish but easy to omit for a vegetarian version.",
    imageEmoji: "🥞",
    cookTimeMinutes: 45,
    servings: 2,
    ingredients: [
  ...
  },
  {
    ...
    description: "Chicken and vegetables simmered with deeply caramelized onions, finished with grated apple and honey - the 30-40 minute onion caramelization is what builds the curry's savory-sweet depth, not just the roux.",
    imageEmoji: "🍛",
    cookTimeMinutes: 75,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "Chicken wings coated in potato starch and fried twice - the second fry at a higher temperature is what boils off the extra moisture and creates the glass-like crackling crust real Korean fried chicken is known for - tossed in a garlic-ginger gochujang glaze.",
    imageEmoji: "🍗",
    cookTimeMinutes: 60,
    servings: 4,
    ingredients: [
  ...
  },
  {
    slug: "japchae",
    title: "Japchae",
    description: "Sweet potato glass noodles tossed with beef, mushrooms, and vegetables that are each stir-fried and seasoned separately before combining - cooking everything together muddies the colors and textures that define real japchae.",
    imageEmoji: "🍜",
    cookTimeMinutes: 50,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "Thin-cut short ribs marinated in a soy-garlic sauce built on grated Korean pear and onion, which tenderize the meat as much as they sweeten it, then grilled quickly - the grated onion and pear are what separate real galbi from a simple soy marinade.",
    imageEmoji: "🍖",
    cookTimeMinutes: 400,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "Chopped romaine, radish, and green onion tossed with tomato and cucumber in a lemon-pomegranate molasses dressing sharpened with sumac - the lettuce base and pomegranate molasses are what most simplified versions leave out entirely.",
    imageEmoji: "🥗",
    cookTimeMinutes: 25,
    servings: 4,
    ingredients: [
  ...
  },
  {
    slug: "mujadara",
    title: "Mujadara",
    description: "Lentils and rice cooked in the flavorful oil left from frying the onions, topped with a portion of those onions fried extra crispy - using the onion oil to cook the grains, not just plain water, is what makes real mujadara taste the way it does.",
    imageEmoji: "🍚",
    cookTimeMinutes: 60,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "Soft flatbread dimpled with fingertips before baking so the olive oil-za'atar topping settles into the dough instead of running off - the dimpling technique is what gives manakish its name and its signature texture.",
    imageEmoji: "🫓",
    cookTimeMinutes: 40,
    servings: 6,
    ingredients: [
  ...
  },
  {
    slug: "muhammara",
    title: "Muhammara",
    description: "A smoky roasted red pepper and toasted walnut dip sharpened with Aleppo pepper, garlic, cumin, and pomegranate molasses - Aleppo pepper is the ingredient that gives muhammara its signature gentle heat and fruity depth, and toasting the walnuts first keeps them from tasting waxy.",
    imageEmoji: "🌶️",
    cookTimeMinutes: 30,
    servings: 6,
    ingredients: [
  ...
  },
  {
    slug: "jerk-chicken",
    title: "Jerk Chicken",
    description: "Chicken marinated in a blended fresh paste of scotch bonnet, allspice, scallion, thyme, garlic, and ginger - it's the allspice and scotch bonnet blended fresh, not a store-bought seasoning blend rubbed on dry, that gives real jerk its depth.",
    imageEmoji: "🍗",
    cookTimeMinutes: 90,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "A pressed sandwich of ham, mojo-marinated roast pork, Swiss cheese, and pickles on Cuban bread, buttered on the outside before pressing for the crisp, golden crust that defines a real Cubano.",
    imageEmoji: "🥪",
    cookTimeMinutes: 20,
    servings: 2,
    ingredients: [
  ...
  },
  {
    ...
    description: "Coconut rice simmered with kidney beans, scallion, garlic, and thyme, with a whole scotch bonnet pepper added for its fragrance and a touch of heat without overwhelming spice - removing the pepper whole afterward is the classic technique for flavor without fire.",
    imageEmoji: "🍚",
    cookTimeMinutes: 40,
    servings: 6,
    ingredients: [
  ...
  },
  {
    ...
    description: "Chicken browned then slow-simmered with garlic, ginger, saffron, and preserved lemon alongside apricots and olives - preserved lemon is the salty, intensely citrusy ingredient real tagine can't be made without, and fresh lemon isn't a substitute.",
    imageEmoji: "🍗",
    cookTimeMinutes: 70,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "Onions cooked low and slow until deeply softened before the berbere and garlic-ginger go in, then simmered with red lentils - the long, patient onion cook is the technique real misir wot is built on, not just a quick sauté.",
    imageEmoji: "🍲",
    cookTimeMinutes: 65,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "Chicken marinated in a blended fresh sauce of bird's eye chilies, garlic, paprika, oregano, lemon, and vinegar - the fresh chili-garlic blend, not a bottled sauce, is what real peri-peri is built on.",
    imageEmoji: "🌶️",
    cookTimeMinutes: 280,
    servings: 4,
    ingredients: [
  ...
  },
  {
    slug: "bobotie",
    title: "Bobotie",
    description: "Curried ground beef bound with milk-soaked bread and sweetened with apricot jam, baked under a turmeric-egg custard studded with bay leaves - the soaked bread is the traditional binder that keeps bobotie moist, not just meat and spice.",
    imageEmoji: "🥘",
    cookTimeMinutes: 75,
    servings: 6,
    ingredients: [
  ...
  },
  {
    ...
    description: "Black beans simmered for over an hour with smoked sausage, pork, bay leaf, and cumin until deeply thickened - traditionally served with rice, orange slices, and sautéed greens to cut the richness.",
    imageEmoji: "🍲",
    cookTimeMinutes: 100,
    servings: 6,
    ingredients: [
  ...
  },
  {
    ...
    description: "Grilled steak topped with chimichurri built on oregano and red pepper flakes as much as parsley and garlic, rested at least 30 minutes before serving so the flavors meld - skipping the rest is the most common way home versions fall short.",
    imageEmoji: "🥩",
    cookTimeMinutes: 30,
    servings: 4,
    ingredients: [
  ...
  },
  {
    slug: "empanadas",
    title: "Empanadas",
    description: "Flaky pastry pockets filled with beef seasoned with paprika, cumin, and oregano, folded in hard-boiled egg and olives once cooled - the hard-boiled egg is a defining ingredient in real Argentine empanadas, added off the heat so it doesn't turn to mush.",
    imageEmoji: "🥟",
    cookTimeMinutes: 90,
    servings: 8,
    ingredients: [
  ...
  },
  {
    ...
    description: "Chicken and rice built on a blended sofrito of onion, garlic, bell pepper, and cilantro, colored with achiote instead of turmeric, with the rice toasted in the sofrito before the broth goes in - the sofrito and toasting step are what real arroz con pollo is built on, not just spiced rice and chicken.",
    imageEmoji: "🍚",
    cookTimeMinutes: 55,
    servings: 6,
    ingredients: [
  ...
  },
  {
    ...
    description: "Beef seared hard and fast over high heat, stir-fried with garlic, aji amarillo paste, and tomatoes, then tossed with crispy fries right in the wok - aji amarillo is the ingredient that gives lomo saltado its authentic flavor, and real high heat is what keeps the beef from steaming gray.",
    imageEmoji: "🥩",
    cookTimeMinutes: 35,
    servings: 4,
    ingredients: [
  ...
  },
  {
    slug: "bruschetta",
    title: "Bruschetta",
    description: "Toasted rustic bread rubbed with raw garlic while still hot, topped with salted tomatoes rested to draw out their juices, and fresh basil - the garlic goes on the bread itself, not into the topping.",
    imageEmoji: "🍅",
    cookTimeMinutes: 25,
    servings: 6,
    ingredients: [
  ...
  },
  {
    ...
    description: "Pan-seared chicken cutlets in a bright lemon-caper butter sauce built on a shallot-garlic and white wine base, finished off the heat so the butter turns glossy instead of greasy.",
    imageEmoji: "🍋",
    cookTimeMinutes: 35,
    servings: 4,
    ingredients: [
