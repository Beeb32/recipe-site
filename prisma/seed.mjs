...
const recipes = [
  ...
  },
  {
    slug: "bibimbap",
    title: "Bibimbap",
    description: "Rice bowl topped with individually seasoned namul vegetables, mushrooms, and beef marinated in a soy-garlic-pear sauce - seasoning each vegetable separately with sesame oil and garlic is the technique real bibimbap namul is built on, not just blanching them plain.",
    imageEmoji: "🍚",
    cookTimeMinutes: 55,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "An inside-out roll (uramaki) with seasoned sushi rice on the outside coated in toasted sesame seeds, wrapping nori around crab, avocado, and cucumber - the rice-outside technique is what actually makes a California roll, not just a roll with imitation crab.",
    imageEmoji: "🍣",
    cookTimeMinutes: 45,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "Stir-fried noodles built on a garlic-ginger-scallion base and a real lo mein sauce of light and dark soy sauce, oyster sauce, and sugar - the aromatics and layered sauce are what separate real lo mein from noodles tossed in plain soy sauce.",
    imageEmoji: "🍜",
    cookTimeMinutes: 30,
    servings: 4,
    ingredients: [
  ...
  },
  {
    slug: "poke-bowl",
    title: "Poke Bowl",
    description: "Sushi-grade tuna marinated in shoyu, sesame oil, green onion, and sesame seeds, rested to let the marinade soften the fish - green onion and sesame seeds are standard components of real shoyu poke, not just soy sauce and oil.",
    imageEmoji: "🍚",
    cookTimeMinutes: 75,
    servings: 4,
    ingredients: [
