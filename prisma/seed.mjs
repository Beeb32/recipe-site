...
const recipes = [
  ...
  },
  {
    ...
    description: "Thin-sliced beef marinated in a sweet soy-garlic sauce and quickly grilled.",
    imageEmoji: "🥩",
    cookTimeMinutes: 30,
    servings: 4,
    ingredients: [
    ...
    steps: [
      ...
      "Marinate the beef in the mixture for at least 30 minutes.",
      "Cook the beef in a hot skillet or grill in batches until browned, about 2-3 minutes per side.",
      "Serve hot with rice.",
    ],
    tags: ["dinner", "asian", "quick"],
  },
  ...
  },
  {
    ...
    description: "Tangy, spicy fried rice made with kimchi and topped with a fried egg.",
    imageEmoji: "🍚",
    cookTimeMinutes: 20,
    servings: 4,
    ingredients: [
      { text: "4 cups cooked, cooled rice", ingredient: "rice", quantity: 4 },
      { text: "1 1/2 cups chopped kimchi", ingredient: "kimchi", quantity: 1.5 },
      { text: "4 eggs", ingredient: "eggs", quantity: 4 },
      { text: "2 tbsp gochujang", ingredient: "gochujang", quantity: 2 },
      { text: "2 tbsp sesame oil", ingredient: "sesame oil", quantity: 2 },
    ],
    steps: [
      "Heat sesame oil in a large skillet and stir-fry the kimchi for 2-3 minutes.",
      "Add the rice and gochujang, stir-frying for 4-5 minutes until well combined.",
  ...
  },
  {
    ...
    description: "A vibrant Spanish rice dish loaded with shrimp, mussels, and saffron.",
    imageEmoji: "🥘",
    cookTimeMinutes: 50,
    servings: 6,
    ingredients: [
      ...
      { text: "1 onion, diced", ingredient: "onion", quantity: 1 },
      { text: "1/2 tsp saffron threads", ingredient: "saffron", quantity: 0.5 },
      { text: "4 cups seafood or chicken broth", ingredient: "seafood broth", quantity: 4 },
    ],
    steps: [
      "Sauté the onion in a large paella pan or skillet until softened.",
      "Add the rice and saffron, stirring to coat, then pour in the broth.",
      "Simmer without stirring for 15 minutes.",
      "Nestle the shrimp and mussels into the rice and cook for another 8-10 minutes until the seafood is cooked through.",
    ],
    tags: ["dinner", "mediterranean"],
  },
  {
