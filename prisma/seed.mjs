...
const recipes = [
  ...
  },
  {
    ...
    description: "Clams, potatoes, and bacon in a chowder built on a proper roux with celery, thyme, and bay leaf simmered into the base - celery and the herbs are what most simplified versions leave out, and the chowder should only ever simmer, never boil, once the cream goes in.",
    imageEmoji: "🥣",
    cookTimeMinutes: 55,
    servings: 6,
    ingredients: [
  ...
  },
  {
    ...
    description: "Ribeye frozen briefly then shaved paper-thin, chopped into small pieces with the spatula as it sears - that chopping technique, not just thin slicing, is what gives a real cheesesteak its texture - piled with melted cheese into a toasted roll.",
    imageEmoji: "🥪",
    cookTimeMinutes: 30,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "Linguine tossed with shrimp in a garlic-white wine butter sauce built with shallot, red pepper flakes, and starchy pasta water to emulsify - the pasta water and chili flakes are what real scampi is built on, not just butter and wine.",
    imageEmoji: "🍝",
    cookTimeMinutes: 25,
    servings: 4,
    ingredients: [
  ...
  },
  {
    slug: "crab-cakes",
    title: "Crab Cakes",
    description: "Lump crab meat bound with a minimal Old Bay-mustard-Worcestershire mixture and chilled before frying - Old Bay and minimal filler are what define real Maryland crab cakes, and chilling is what keeps them from falling apart in the pan.",
    imageEmoji: "🦀",
    cookTimeMinutes: 55,
    servings: 4,
    ingredients: [
