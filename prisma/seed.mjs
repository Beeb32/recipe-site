...
const recipes = [
  ...
  },
  {
    slug: "caesar-salad",
    title: "Caesar Salad",
    description: "Romaine tossed in a real Caesar dressing emulsified from egg yolk and oil with anchovy, garlic, and Worcestershire sauce - anchovy is the ingredient most simplified versions leave out entirely, even though it's what gives Caesar dressing its signature savory depth.",
    imageEmoji: "🥗",
    cookTimeMinutes: 20,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "Cubed beef simmered low and slow in a paste of toasted, rehydrated dried chiles with garlic and cumin, thickened with masa harina - authentic Texas \"bowl of red\" uses no beans at all and dried chiles instead of chili powder.",
    imageEmoji: "🌶️",
    cookTimeMinutes: 240,
    servings: 6,
    ingredients: [
  ...
  },
  {
    slug: "eggs-benedict",
    title: "Eggs Benedict",
    description: "Poached eggs and Canadian bacon on toasted English muffins, draped in hollandaise made with hot (not just melted) butter and seasoned with salt and cayenne - the hot butter is what allows the sauce to emulsify properly, and cayenne is the traditional finishing touch most simplified versions skip.",
    imageEmoji: "🍳",
    cookTimeMinutes: 30,
    servings: 2,
    ingredients: [
  ...
  },
  {
    ...
    description: "Lightly fried corn tortillas topped with fried eggs and a cooked salsa ranchera of charred tomato, onion, garlic, and jalapeño - the cooked ranchera sauce, not jarred salsa, is what real huevos rancheros is built on, finished with crumbled cotija and avocado.",
    imageEmoji: "🌶️",
    cookTimeMinutes: 35,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "Penne in a fiery garlic-chili tomato sauce finished with starchy pasta water for a glossy cling and fresh parsley - traditionally served with no cheese at all, so the heat and tomato stay front and center.",
    imageEmoji: "🍝",
    cookTimeMinutes: 25,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "Pillowy potato gnocchi finished in a nutty brown butter and crispy sage sauce, pan-seared briefly for a light crust instead of just tossed - letting the gnocchi sit undisturbed to brown on one side is what gives the dish its textural contrast.",
    imageEmoji: "🥔",
    cookTimeMinutes: 25,
    servings: 4,
    ingredients: [
  ...
  },
  {
    slug: "cornbread",
    title: "Cornbread",
    description: "Southern-style buttermilk cornbread baked in a preheated cast-iron skillet with sizzling fat - no sugar, since that turns it into cornmeal cake rather than the savory bread Southern cornbread actually is.",
    imageEmoji: "🌽",
    cookTimeMinutes: 35,
    servings: 8,
    ingredients: [
  ...
  },
  {
    ...
    description: "Rice built on the Creole holy trinity of onion, celery, and bell pepper, simmered with garlic, thyme, and bay leaf alongside chicken and sausage - celery and garlic were missing entirely before, though they're core to the trinity real jambalaya is built on.",
    imageEmoji: "🍚",
    cookTimeMinutes: 60,
    servings: 6,
    ingredients: [
  ...
  },
  {
    slug: "key-lime-pie",
    title: "Key Lime Pie",
    description: "Graham cracker crust pre-baked before filling, key lime custard baked until just set, topped with fresh whipped cream just before serving - baking the crust first keeps it from turning soggy, and real key lime juice (not standard lime) gives the tart, floral flavor the pie is named for.",
    imageEmoji: "🥧",
    cookTimeMinutes: 240,
    servings: 8,
    ingredients: [
  ...
  },
  {
    slug: "shrimp-tacos",
    title: "Shrimp Tacos",
    description: "Shrimp marinated in a fresh spice blend of chili powder, cumin, garlic, and lime, seared until charred at the edges, and served over a cilantro-lime cabbage slaw - the lime and cilantro in the slaw, not just sour cream, are what make these taste like real Mexican shrimp tacos.",
    imageEmoji: "🌮",
    cookTimeMinutes: 25,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "Fish battered in cold beer and baking powder for extra crunch, deep-fried, and topped with lime crema and slaw - the baking powder is what makes the batter puff up light and crisp, and real Baja tacos are finished with fresh lime and cilantro, not just chipotle mayo.",
    imageEmoji: "🌮",
    cookTimeMinutes: 35,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "Watermelon and mellowed red onion tossed with feta, mint, and a lime-olive oil dressing - red onion is a near-universal ingredient this recipe was missing entirely, and rinsing it under water first is what takes the raw bite off.",
    imageEmoji: "🍉",
    cookTimeMinutes: 15,
    servings: 4,
    ingredients: [
  ...
  },
  {
    slug: "panzanella",
    title: "Panzanella",
    description: "Stale bread soaked in water and squeezed dry rather than toasted, tossed with tomatoes, mellowed red onion, and basil in a simple oil-and-vinegar dressing - soaking (not toasting) the bread is the traditional Tuscan technique, and red onion is a near-universal ingredient the original recipe left out.",
    imageEmoji: "🍅",
    cookTimeMinutes: 30,
    servings: 4,
    ingredients: [
  ...
  },
  {
    slug: "lobster-rolls",
    title: "Lobster Rolls",
    description: "Chilled lobster meat tossed in a light mayonnaise dressing, piled into a split-top bun griddled golden in butter on both flat sides - griddling the bun in butter, not just toasting it, is the real New England technique.",
    imageEmoji: "🦞",
    cookTimeMinutes: 20,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "Fish dredged in seasoned flour before dipping in a cold beer batter, and chips double-fried at a lower temperature first, then hotter for crisping - the seasoned flour dredge and double-fry are what separate real British fish and chips from a single-fry version.",
    imageEmoji: "🐟",
    cookTimeMinutes: 50,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "A puffy, oven-baked pancake risen by steam from a hot cast-iron skillet, finished with lemon juice and powdered sugar - the classic topping, which most simplified versions leave off entirely.",
    imageEmoji: "🥞",
    cookTimeMinutes: 30,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "Flaky buttermilk biscuits smothered in sausage gravy made in the same skillet the sausage browned in, without draining the fat - the rendered sausage fat, not fresh butter or oil, is what carries the gravy's flavor.",
    imageEmoji: "🍞",
    cookTimeMinutes: 35,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "Spaghetti tossed in oil where thin-sliced garlic is infused from a cold start over low heat until pale gold - never dark brown - then emulsified with starchy pasta water; low heat is non-negotiable, since garlic turns bitter in seconds if it gets too hot.",
    imageEmoji: "🍝",
    cookTimeMinutes: 20,
    servings: 4,
    ingredients: [
  ...
  },
  {
    slug: "mango-lassi",
    title: "Mango Lassi",
    description: "Yogurt and mango blended with a pinch of ground cardamom and a touch of salt - cardamom is the spice that gives real mango lassi its signature aromatic lift, and it was missing entirely before.",
    imageEmoji: "🥭",
    cookTimeMinutes: 10,
    servings: 2,
    ingredients: [
  ...
  },
  {
    ...
    description: "Whole spices and fresh ginger simmered in water first before the milk goes in - boiling ginger before adding milk is what keeps the milk from curdling, and simmering the spices in water alone extracts their aroma more fully than milk does.",
    imageEmoji: "☕",
    cookTimeMinutes: 20,
    servings: 2,
    ingredients: [
  ...
  },
  {
    slug: "horchata",
    title: "Horchata",
    description: "Rice, cinnamon, and blanched almonds soaked overnight then blended and strained silky-smooth, sweetened with sugar and a touch of vanilla - the almonds and vanilla are what most simplified versions of this Mexican rice drink leave out.",
    imageEmoji: "🥤",
    cookTimeMinutes: 300,
    servings: 6,
    ingredients: [
  ...
  },
  {
    ...
    description: "Chicken dredged and seared for a golden crust, mushrooms browned separately until dry before returning to the pan, and dry Marsala (not sweet) deglazed off the heat and reduced until it coats a spoon - dry Marsala and letting the mushrooms brown properly are what most simplified versions get wrong.",
    imageEmoji: "🍗",
    cookTimeMinutes: 35,
    servings: 4,
    ingredients: [
