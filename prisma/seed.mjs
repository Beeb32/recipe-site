...
const recipes = [
  ...
  },
  {
    ...
    description: "Chicken and vegetables simmered in a fragrant coconut green curry sauce.",
    imageEmoji: "🍛",
    cookTimeMinutes: 30,
    servings: 4,
    ingredients: [
    ...
    steps: [
      ...
      "Pour in the remaining coconut milk, bamboo shoots, and red pepper, simmering for 10 minutes.",
  ...
  },
  {
    ...
    description: "A rich, spicy coconut curry with beef and vegetables.",
    imageEmoji: "🍛",
    cookTimeMinutes: 30,
    servings: 4,
    ingredients: [
    ...
    steps: [
      "Fry the red curry paste in a splash of coconut milk until fragrant.",
      "Add the beef and cook until browned.",
      "Pour in the remaining coconut milk and bell peppers, simmering for 12-15 minutes.",
      "Stir in the fish sauce and brown sugar before serving.",
    ],
    tags: ["dinner", "asian"],
  },
  {
    slug: "tom-yum-soup",
    title: "Tom Yum Soup",
    description: "A hot and sour Thai soup with shrimp, lemongrass, and mushrooms.",
    imageEmoji: "🍲",
    cookTimeMinutes: 25,
    servings: 4,
    ingredients: [
      ...
      { text: "2 stalks lemongrass, smashed", ingredient: "lemongrass", quantity: 2 },
      { text: "3 tbsp lime juice", ingredient: "lime juice", quantity: 3 },
      { text: "2 tbsp fish sauce", ingredient: "fish sauce", quantity: 2 },
    ],
    steps: [
      "Bring the chicken broth to a simmer with the lemongrass for 10 minutes to infuse.",
      "Add the mushrooms and simmer for 5 minutes.",
      "Add the shrimp and cook until pink, about 3 minutes.",
      "Remove from heat and stir in the lime juice and fish sauce.",
    ],
  ...
  },
  {
    ...
    description: "A mild, rich Thai curry with beef, potatoes, and peanuts.",
    imageEmoji: "🍛",
    cookTimeMinutes: 60,
    servings: 4,
    ingredients: [
    ...
    steps: [
      ...
      "Add the beef and cook until browned.",
      "Pour in the remaining coconut milk and potatoes, then simmer covered for 40 minutes until tender.",
      "Stir in the peanuts and fish sauce before serving.",
    ],
    tags: ["dinner", "asian"],
  },
  {
  ...
  },
  {
    slug: "beef-pho",
    title: "Beef Pho",
    description: "A fragrant Vietnamese noodle soup with thin-sliced beef in a spiced broth.",
    imageEmoji: "🍜",
    cookTimeMinutes: 60,
    servings: 4,
    ingredients: [
    ...
    steps: [
      "Simmer the beef broth with onion, cinnamon stick, and star anise for 30 minutes to infuse.",
      "Cook the rice noodles according to package instructions, then divide among bowls.",
      "Strain the broth and bring back to a rolling simmer.",
      "Top the noodles with raw sliced beef and ladle the hot broth over to cook it through.",
    ],
    tags: ["dinner", "asian"],
  },
  {
    slug: "banh-mi",
    title: "Banh Mi",
    description: "A Vietnamese sandwich of crusty baguette filled with pork, pickled vegetables, and herbs.",
    imageEmoji: "🥖",
    cookTimeMinutes: 30,
    servings: 4,
    ingredients: [
      { text: "1 lb pork tenderloin, sliced", ingredient: "pork tenderloin", quantity: 1 },
      { text: "2 baguettes, halved", ingredient: "baguette", quantity: 2 },
      { text: "1 cup pickled carrots and daikon", ingredient: "pickled vegetables", quantity: 1 },
      { text: "1/4 cup mayonnaise", ingredient: "mayonnaise", quantity: 0.25 },
      { text: "1/4 cup fresh cilantro", ingredient: "cilantro", quantity: 0.25 },
      { text: "2 tbsp soy sauce", ingredient: "soy sauce", quantity: 2 },
    ],
    steps: [
      "Marinate the pork in soy sauce for 15 minutes, then cook in a hot skillet until browned and cooked through.",
      "Spread mayonnaise on the baguettes.",
      "Layer the pork, pickled vegetables, and cilantro into the baguettes.",
      "Slice and serve.",
    ],
    tags: ["lunch", "asian", "quick"],
  },
  ...
  },
  {
    slug: "chicken-katsu",
    title: "Chicken Katsu",
    description: "Crispy panko-breaded chicken cutlets served with a tangy katsu sauce.",
    imageEmoji: "🍗",
    cookTimeMinutes: 30,
    servings: 4,
    ingredients: [
      ...
      { text: "1/2 cup katsu sauce", ingredient: "katsu sauce", quantity: 0.5 },
    ],
    steps: [
      "Dredge each chicken breast in flour, then egg, then panko breadcrumbs.",
      "Heat oil in a skillet and fry the chicken for 3-4 minutes per side until golden and cooked through.",
      "Drain on paper towels and slice into strips.",
      "Serve drizzled with katsu sauce.",
    ],
    tags: ["dinner", "asian"],
  },
  {
