...
const recipes = [
  ...
  },
  {
    slug: "malai-kofta",
    title: "Malai Kofta",
    description: "Fried vegetable and paneer dumplings served in a rich, creamy tomato sauce.",
    imageEmoji: "🍛",
    cookTimeMinutes: 50,
    servings: 4,
    ingredients: [
      { text: "2 potatoes, boiled and mashed", ingredient: "potato", quantity: 2 },
      { text: "1/2 cup crumbled paneer", ingredient: "paneer", quantity: 0.5 },
      { text: "3 tbsp flour", ingredient: "flour", quantity: 3 },
      { text: "1 can crushed tomatoes", ingredient: "tomato", quantity: 1 },
      { text: "1/2 cup heavy cream", ingredient: "heavy cream", quantity: 0.5 },
      { text: "2 cups vegetable oil for frying", ingredient: "vegetable oil", quantity: 2 },
    ...
    steps: [
      "Mix the mashed potato, paneer, and flour into a dough, then form into small balls.",
      "Fry the balls in hot oil until golden, then drain.",
      "Simmer the crushed tomatoes with cream until thickened into a smooth sauce.",
  ...
  },
  {
    ...
    description: "Rice paper rolls filled with shrimp, herbs, and vermicelli noodles - no frying required.",
    imageEmoji: "🌯",
    cookTimeMinutes: 35,
    servings: 4,
    ingredients: [
      { text: "12 rice paper wrappers", ingredient: "rice paper", quantity: 12 },
      { text: "1 lb shrimp, cooked and halved", ingredient: "shrimp", quantity: 1 },
      { text: "4 oz vermicelli noodles, cooked", ingredient: "vermicelli noodles", quantity: 4 },
      { text: "1 cup fresh mint and basil leaves", ingredient: "fresh herbs", quantity: 1 },
      { text: "1 cup shredded lettuce", ingredient: "lettuce", quantity: 1 },
    ],
    steps: [
      "Dip each rice paper wrapper briefly in warm water to soften.",
      "Layer lettuce, noodles, herbs, and shrimp near the bottom edge.",
      "Fold in the sides and roll tightly like a burrito.",
      "Serve with peanut or dipping sauce.",
    ],
    tags: ["lunch", "asian", "quick"],
  },
  {
  ...
  },
  {
    ...
    description: "Spiced, marinated chicken roasted until charred, served in warm flatbread.",
    imageEmoji: "🌯",
    cookTimeMinutes: 40,
    servings: 4,
    ingredients: [
    ...
    steps: [
      "Marinate the chicken in olive oil, cumin, paprika, and lemon juice for at least 30 minutes.",
  ...
  },
  {
    slug: "kofta-kebabs",
    title: "Kofta Kebabs",
    description: "Spiced ground beef skewers grilled until juicy and lightly charred.",
    imageEmoji: "🍢",
    cookTimeMinutes: 30,
    servings: 4,
    ingredients: [
    ...
    steps: [
      "Mix the ground beef with onion, garlic, cumin, and parsley.",
      "Shape the mixture around skewers into long oval patties.",
  ...
  },
  {
    ...
    description: "Marinated pork tacos with a hint of pineapple, inspired by Mexican street food.",
    imageEmoji: "🌮",
    cookTimeMinutes: 40,
    servings: 4,
    ingredients: [
      { text: "1 1/2 lb pork shoulder, sliced thin", ingredient: "pork shoulder", quantity: 1.5 },
      { text: "3 tbsp adobo sauce", ingredient: "adobo sauce", quantity: 3 },
      { text: "1 cup pineapple chunks", ingredient: "pineapple", quantity: 1 },
      { text: "8 small corn tortillas", ingredient: "corn tortillas", quantity: 8 },
    ...
    steps: [
      "Marinate the pork in adobo sauce for at least 30 minutes.",
      "Cook the pork in a hot skillet until browned and cooked through, about 8-10 minutes.",
      "Sear the pineapple chunks in the same pan until caramelized.",
      "Fill warm tortillas with pork, pineapple, onion, and cilantro.",
    ],
    tags: ["dinner", "mexican"],
  },
  {
