...
const recipes = [
  ...
  },
  {
    slug: "palak-paneer",
    title: "Palak Paneer",
    description: "Cubes of soft paneer cheese simmered in a creamy, spiced spinach sauce.",
    imageEmoji: "🍛",
    cookTimeMinutes: 40,
    servings: 4,
    ingredients: [
    ...
    steps: [
      "Blanch the spinach in boiling water for 2 minutes, then blend until smooth.",
      "Sauté the onion and garlic until softened, then stir in the garam masala.",
      "Add the spinach purée and simmer for 10 minutes.",
      "Stir in the paneer and cream, simmering for another 5 minutes before serving.",
    ],
    tags: ["dinner", "vegetarian"],
  },
  {
    slug: "chana-masala",
    title: "Chana Masala",
    description: "Chickpeas simmered in a spiced tomato-onion gravy - a hearty vegan classic.",
    imageEmoji: "🍛",
    cookTimeMinutes: 35,
    servings: 4,
    ingredients: [
    ...
    steps: [
      ...
      "Stir in the garam masala and cook for 1 minute until fragrant.",
      "Add the diced tomatoes and simmer for 10 minutes.",
      "Stir in the chickpeas and simmer for another 10-15 minutes until thickened.",
    ],
  ...
  },
  {
    slug: "dal-tadka",
    title: "Dal Tadka",
    description: "Yellow lentils simmered until creamy, finished with a sizzling garlic-cumin tempering.",
    imageEmoji: "🍲",
    cookTimeMinutes: 35,
    servings: 4,
    ingredients: [
      { text: "1 1/2 cups yellow split lentils", ingredient: "lentils", quantity: 1.5 },
      { text: "1 onion, diced", ingredient: "onion", quantity: 1 },
      { text: "1 tomato, diced", ingredient: "tomato", quantity: 1 },
    ...
    steps: [
      "Simmer the lentils with turmeric and 4 cups water until soft, about 20 minutes.",
      "Stir in the onion and tomato, simmering for another 5 minutes.",
      "Melt the butter in a small pan and fry the garlic until golden.",
      "Pour the sizzling garlic butter over the dal just before serving.",
    ],
    tags: ["dinner", "vegetarian"],
  },
  {
  ...
  },
  {
    ...
    servings: 6,
    ingredients: [
      { text: "2 cups basmati rice", ingredient: "basmati rice", quantity: 2 },
      { text: "2 carrots, diced", ingredient: "carrot", quantity: 2 },
    ...
    steps: [
      "Cook the basmati rice until just shy of tender, then drain.",
      "Fry the onion in oil until deeply golden and crisp; set aside.",
      "Sauté the carrots and peas with garam masala until just tender.",
      "Layer the rice and vegetables in a pot, top with fried onions, cover, and steam on low heat for 10 minutes.",
    ],
    tags: ["dinner", "vegan", "vegetarian"],
  },
  {
    ...
    description: "Spiced, marinated chicken layered with fragrant basmati rice and fried onions.",
    imageEmoji: "🍛",
    cookTimeMinutes: 60,
    servings: 6,
    ingredients: [
      ...
      { text: "2 cups basmati rice", ingredient: "basmati rice", quantity: 2 },
      { text: "1 cup yogurt", ingredient: "yogurt", quantity: 1 },
      { text: "2 onions, sliced", ingredient: "onion", quantity: 2 },
      { text: "2 tbsp biryani masala", ingredient: "biryani masala", quantity: 2 },
      { text: "3 tbsp vegetable oil", ingredient: "vegetable oil", quantity: 3 },
    ],
    steps: [
      "Marinate the chicken in yogurt and biryani masala for at least 30 minutes.",
      "Fry the onions in oil until deeply golden and crisp; set aside.",
      "Cook the marinated chicken until nearly done, then set aside.",
      "Parboil the rice, layer it over the chicken with fried onions, cover, and steam on low heat for 15-20 minutes.",
    ],
    tags: ["dinner"],
  },
  {
  ...
  },
  {
    slug: "shopska-salad",
    title: "Shopska Salad",
    description: "Bulgaria's national salad of tomatoes, cucumbers, and peppers topped with grated white cheese.",
    imageEmoji: "🥗",
    cookTimeMinutes: 15,
    servings: 4,
    ingredients: [
      { text: "4 tomatoes, diced", ingredient: "tomato", quantity: 4 },
      { text: "2 cucumbers, diced", ingredient: "cucumber", quantity: 2 },
    ...
    steps: [
      "Combine the tomatoes, cucumbers, green pepper, and red onion in a large bowl.",
      "Drizzle with sunflower oil and toss gently.",
      "Divide among plates or serve in one large bowl.",
      "Generously grate the sirene cheese over the top just before serving.",
    ],
    tags: ["lunch", "vegetarian", "quick", "salad"],
  },
  {
    slug: "banitsa",
    title: "Banitsa",
    description: "A flaky Bulgarian pastry made of layered phyllo dough filled with eggs and sirene cheese.",
    imageEmoji: "🥧",
    cookTimeMinutes: 55,
    servings: 8,
    ingredients: [
      { text: "1 package phyllo dough", ingredient: "phyllo dough", quantity: 1 },
      { text: "4 eggs", ingredient: "eggs", quantity: 4 },
      { text: "2 cups crumbled sirene (Bulgarian white cheese)", ingredient: "sirene", quantity: 2 },
      { text: "1 cup plain yogurt", ingredient: "yogurt", quantity: 1 },
      { text: "1/2 cup melted butter", ingredient: "butter", quantity: 0.5 },
    ],
    steps: [
      "Preheat oven to 375°F and grease a baking dish.",
      "Whisk together the eggs, sirene, and yogurt.",
      "Crumple sheets of phyllo loosely, dip lightly in the egg mixture, and layer into the dish, brushing occasionally with melted butter.",
  ...
  },
  {
    slug: "tarator",
    title: "Tarator",
    description: "A chilled Bulgarian soup of yogurt, cucumber, garlic, and dill - refreshing on a hot day.",
    imageEmoji: "🥒",
    cookTimeMinutes: 15,
    servings: 4,
    ingredients: [
      ...
      { text: "1/4 cup chopped walnuts", ingredient: "walnuts", quantity: 0.25 },
    ],
    steps: [
      "Whisk the yogurt with a splash of cold water until smooth and pourable.",
      "Stir in the cucumber, garlic, and dill.",
      "Drizzle with sunflower oil and chill for at least 30 minutes.",
  ...
  },
  {
    slug: "kavarma",
    title: "Kavarma",
    description: "A hearty Bulgarian stew of pork and vegetables slow-simmered in a clay pot.",
    imageEmoji: "🍲",
    cookTimeMinutes: 70,
    servings: 4,
    ingredients: [
    ...
    steps: [
      "Brown the pork in sunflower oil in a large pot.",
      "Add the onion and cook until softened.",
      "Stir in the red pepper, mushrooms, and tomato, then cover and simmer for 45-50 minutes until the pork is tender.",
      "Serve hot, traditionally topped with a raw egg cracked over the top just before serving.",
    ],
    tags: ["dinner"],
  },
  {
    slug: "sarmi",
    title: "Sarmi",
    description: "Bulgarian stuffed cabbage rolls filled with rice and minced meat, simmered until tender.",
    imageEmoji: "🥬",
    cookTimeMinutes: 90,
    servings: 6,
    ingredients: [
      { text: "1 head pickled or fresh cabbage, leaves separated", ingredient: "cabbage", quantity: 1 },
      { text: "1 lb ground pork", ingredient: "ground pork", quantity: 1 },
      { text: "1 cup rice", ingredient: "rice", quantity: 1 },
      { text: "1 onion, diced", ingredient: "onion", quantity: 1 },
      { text: "1 tsp paprika", ingredient: "paprika", quantity: 1 },
    ...
    steps: [
      "Mix the ground pork with rice, onion, and paprika.",
      "Place a spoonful of filling on each cabbage leaf and roll tightly, tucking in the sides.",
      "Arrange the rolls snugly in a large pot and pour in the vegetable broth.",
      "Cover and simmer for 1 hour until the rice is cooked and the rolls are tender.",
    ],
    tags: ["dinner"],
  },
  {
    slug: "kyufte",
    title: "Kyufte",
    description: "Bulgarian grilled meat patties seasoned with cumin and fresh herbs.",
    imageEmoji: "🍖",
    cookTimeMinutes: 30,
    servings: 4,
    ingredients: [
    ...
    steps: [
      "Mix the ground meat with onion, cumin, and parsley.",
      "Shape into flattened oval patties.",
      "Cook in sunflower oil over medium heat for 4-5 minutes per side until cooked through.",
  ...
  },
  {
    slug: "kebapche",
    title: "Kebapche",
    description: "Grilled minced meat rolls seasoned with cumin and black pepper - a Bulgarian grill favorite.",
    imageEmoji: "🍢",
    cookTimeMinutes: 30,
    servings: 4,
    ingredients: [
    ...
    steps: [
      "Mix the ground meat with garlic, cumin, pepper, and baking soda.",
      "Let the mixture rest in the fridge for at least 1 hour.",
      "Shape into small logs.",
      "Grill over medium-high heat for 4-5 minutes per side until cooked through and charred in spots.",
    ],
    tags: ["dinner", "quick"],
  },
  {
    slug: "bob-chorba",
    title: "Bob Chorba",
    description: "A hearty Bulgarian bean soup simmered with vegetables and paprika.",
    imageEmoji: "🍲",
    cookTimeMinutes: 60,
    servings: 6,
    ingredients: [
    ...
    steps: [
      "Simmer the soaked beans in fresh water until nearly tender, about 30 minutes.",
      "Sauté the onion, carrot, and red pepper in sunflower oil with paprika until softened.",
      "Add the vegetables to the beans and simmer for another 20 minutes.",
      "Season to taste before serving.",
    ],
    tags: ["dinner", "vegan", "vegetarian"],
  },
  {
    ...
    description: "A baked casserole of potatoes and spiced minced meat topped with a tangy yogurt custard.",
    imageEmoji: "🥘",
    cookTimeMinutes: 75,
    servings: 6,
    ingredients: [
      { text: "1 lb ground pork", ingredient: "ground pork", quantity: 1 },
      { text: "4 potatoes, sliced", ingredient: "potato", quantity: 4 },
      { text: "1 onion, diced", ingredient: "onion", quantity: 1 },
      { text: "1 tsp paprika", ingredient: "paprika", quantity: 1 },
      { text: "2 eggs", ingredient: "eggs", quantity: 2 },
      { text: "1 cup plain yogurt", ingredient: "yogurt", quantity: 1 },
    ...
    steps: [
      "Preheat oven to 375°F.",
      "Brown the ground pork with the onion and paprika.",
      "Layer the sliced potatoes and meat mixture in a baking dish and bake covered for 35 minutes.",
      "Whisk the eggs and yogurt together, pour over the top, and bake uncovered for another 20 minutes until golden.",
    ],
    tags: ["dinner"],
  },
  {
    ...
    description: "A creamy, garlicky Bulgarian yogurt and cucumber salad - light and refreshing.",
    imageEmoji: "🥒",
    cookTimeMinutes: 15,
    servings: 4,
    ingredients: [
      { text: "2 cups thick yogurt", ingredient: "yogurt", quantity: 2 },
      { text: "2 cucumbers, grated and drained", ingredient: "cucumber", quantity: 2 },
      { text: "2 cloves garlic, minced", ingredient: "garlic", quantity: 2 },
      { text: "2 tbsp chopped fresh dill", ingredient: "dill", quantity: 2 },
      { text: "2 tbsp chopped walnuts", ingredient: "walnuts", quantity: 2 },
    ],
    steps: [
      "Mix the yogurt with the grated, drained cucumber.",
      "Stir in the garlic and dill.",
  ...
  },
  {
    slug: "mekitsi",
    title: "Mekitsi",
    description: "Fried Bulgarian dough puffs, crisp outside and soft inside - a beloved breakfast treat.",
    imageEmoji: "🍩",
    cookTimeMinutes: 40,
    servings: 6,
    ingredients: [
    ...
    steps: [
      "Mix the flour, yogurt, egg, and baking soda into a soft dough.",
      "Let rest for 15 minutes.",
      "Flatten small pieces of dough by hand and fry in hot oil until puffed and golden, about 2 minutes per side.",
      "Serve warm dusted with powdered sugar or with sirene cheese.",
    ],
    tags: ["breakfast", "vegetarian"],
  },
  {
    slug: "lyutenitsa",
    title: "Lyutenitsa",
    description: "A rich, slow-cooked relish of roasted peppers and tomatoes - a Bulgarian pantry staple.",
    imageEmoji: "🍅",
    cookTimeMinutes: 60,
    servings: 8,
    ingredients: [
      { text: "6 red bell peppers, roasted and peeled", ingredient: "red pepper", quantity: 6 },
      { text: "4 tomatoes, diced", ingredient: "tomato", quantity: 4 },
      { text: "2 cloves garlic, minced", ingredient: "garlic", quantity: 2 },
      { text: "3 tbsp sunflower oil", ingredient: "sunflower oil", quantity: 3 },
      { text: "Salt to taste", ingredient: "salt", quantity: null },
    ...
    steps: [
      "Blend the roasted peppers and tomatoes until mostly smooth.",
      "Simmer the mixture in a pot with sunflower oil for 40-45 minutes, stirring often, until thickened.",
      "Stir in the garlic during the last 5 minutes of cooking.",
      "Season with salt and cool before serving as a spread.",
    ],
    tags: ["snack", "vegan", "vegetarian"],
  },
  {
    ...
    description: "A rich, garlicky Bulgarian soup traditionally enjoyed as a hangover cure.",
    imageEmoji: "🍲",
    cookTimeMinutes: 60,
    servings: 6,
    ingredients: [
      { text: "2 lb beef tripe, cleaned and cubed", ingredient: "beef tripe", quantity: 2 },
      { text: "6 cups beef broth", ingredient: "beef broth", quantity: 6 },
      { text: "1 cup milk", ingredient: "milk", quantity: 1 },
      { text: "3 tbsp flour", ingredient: "flour", quantity: 3 },
      { text: "4 cloves garlic, minced", ingredient: "garlic", quantity: 4 },
      { text: "2 tbsp paprika oil", ingredient: "paprika", quantity: 2 },
    ],
    steps: [
      "Simmer the tripe in beef broth until very tender, about 40 minutes.",
      "Whisk the flour into the milk until smooth, then stir into the soup to thicken.",
      "Simmer for another 10 minutes.",
      "Serve topped with minced garlic and a drizzle of paprika oil.",
    ],
    tags: ["dinner"],
  },
  {
    slug: "gyuvech",
    title: "Gyuvech",
    description: "A baked Bulgarian casserole of meat and mixed vegetables in a clay pot.",
    imageEmoji: "🥘",
    cookTimeMinutes: 75,
    servings: 6,
    ingredients: [
    ...
    steps: [
      "Preheat oven to 375°F.",
      "Brown the pork in sunflower oil.",
      "Layer the pork and all the vegetables in a baking dish or clay pot.",
      "Cover and bake for 50-55 minutes until the meat and vegetables are tender.",
    ],
    tags: ["dinner"],
  },
  {
    ...
    description: "Bulgarian-style stuffed peppers filled with minced meat, rice, and topped with a savory sauce.",
    imageEmoji: "🫑",
    cookTimeMinutes: 60,
    servings: 6,
    ingredients: [
      { text: "6 bell peppers, tops removed and seeded", ingredient: "bell peppers", quantity: 6 },
      { text: "1 lb ground pork", ingredient: "ground pork", quantity: 1 },
    ...
    steps: [
      "Preheat oven to 375°F.",
      "Mix the ground pork with rice, onion, and paprika.",
      "Stuff the mixture into the peppers and arrange them in a baking dish.",
      "Pour the tomato sauce around the peppers and bake covered for 45-50 minutes until tender.",
    ],
    tags: ["dinner"],
  },
  {
    slug: "ayran",
    title: "Ayran",
    description: "A cooling, salty Bulgarian yogurt drink - the perfect companion to a grilled meal.",
    imageEmoji: "🥤",
    cookTimeMinutes: 5,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    description: "Ripe tomatoes hollowed out and stuffed with seasoned rice and herbs, then baked.",
    imageEmoji: "🍅",
    cookTimeMinutes: 55,
    servings: 6,
    ingredients: [
    ...
    steps: [
      "Preheat oven to 375°F.",
      "Slice the tops off the tomatoes and scoop out the pulp, reserving it.",
      "Sauté the onion in oil, then mix with the rice, reserved tomato pulp, and parsley.",
      "Stuff the mixture into the tomatoes and bake for 35-40 minutes until the rice is tender.",
    ],
    tags: ["dinner", "vegan", "vegetarian"],
  },
  {
    ...
    description: "A light, tangy fish soup finished with paprika and fresh herbs.",
    imageEmoji: "🐟",
    cookTimeMinutes: 40,
    servings: 4,
    ingredients: [
      { text: "1 lb white fish fillets, cubed", ingredient: "white fish", quantity: 1 },
      { text: "1 onion, diced", ingredient: "onion", quantity: 1 },
      { text: "1 carrot, diced", ingredient: "carrot", quantity: 1 },
    ...
    steps: [
      ...
      "Add the broth and paprika, then simmer for 15 minutes.",
  ...
  },
  {
    slug: "mish-mash",
    title: "Mish-Mash",
    description: "A quick Bulgarian scramble of eggs, peppers, tomatoes, and crumbled sirene cheese.",
    imageEmoji: "🍳",
    cookTimeMinutes: 20,
    servings: 2,
    ingredients: [
    ...
    steps: [
      "Sauté the green pepper in sunflower oil until softened.",
      "Add the tomatoes and cook for 3-4 minutes until they break down slightly.",
      "Pour in the beaten eggs and stir gently until just set.",
      "Sprinkle with crumbled sirene before serving.",
    ],
    tags: ["breakfast", "vegetarian", "quick"],
  },
  {
    slug: "garash-cake",
    title: "Garash Cake",
    description: "A rich Bulgarian chocolate and walnut layer cake with a glossy chocolate glaze.",
    imageEmoji: "🍫",
    cookTimeMinutes: 75,
    servings: 12,
    ingredients: [
      ...
      { text: "1 cup heavy cream", ingredient: "heavy cream", quantity: 1 },
      { text: "8 oz dark chocolate, melted", ingredient: "dark chocolate", quantity: 8 },
    ],
    steps: [
      "Preheat oven to 350°F.",
      "Whip the egg whites with sugar to stiff peaks, then fold in the ground walnuts.",
      "Divide among cake pans and bake for 20 minutes until set; cool completely.",
      "Whip the cream, layer between the cooled cake rounds, and coat the outside with melted chocolate.",
    ],
    tags: ["dessert", "vegetarian", "baking"],
  },
];
